...
extension AndroidNotificationChannelMapper on AndroidNotificationChannel {
  Map<String, Object?> toMap() => <String, Object?>{
        ...
        'ledColorAlpha': ledColor?.a,
        'ledColorRed': ledColor?.r,
        'ledColorGreen': ledColor?.g,
        'ledColorBlue': ledColor?.b,
      ...
      'actions': actions
          .map(
            (AndroidNotificationAction e) => <String, dynamic>{
              'id': e.id,
              'title': e.title,
              'titleColorAlpha': e.titleColor?.a,
              'titleColorRed': e.titleColor?.r,
              'titleColorGreen': e.titleColor?.g,
              'titleColorBlue': e.titleColor?.b,
